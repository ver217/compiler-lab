...
;
FuncDecStmt: Specifier FuncDec ';' { $$ = mknode(FUNC_DEC, NULL, NULL, NULL, yylineno); }
;
...
BlockInnerStmtList: { $$=NULL;}
    | VarDecStmt BlockInnerStmtList {$$=mknode(COMP_STM,$1,$2,NULL,yylineno);}
    | Stmt BlockInnerStmtList {$$=mknode(COMP_STM,$1,$2,NULL,yylineno);}
;
BlockStmt: '{' BlockInnerStmtList '}' {$$=$2;}
;
FuncDef: Specifier FuncDec BlockStmt { $$ = mknode(FUNC_DEF, $1, $2, $3, yylineno); }
;
